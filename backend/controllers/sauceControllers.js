...
exports.createSauce = (req, res, next) => {
  ...
  const sauce = new Sauce({
    // Operateur "spread", utilisé pour faire une copie de tous les éléments de req.body.
    ...sauceObject,
    // Création de l'URL de l'image: http(req.protocol)://localhost:3000(req.get("host")/images/filename()
  ...
  if (req.body.like === 0) {
    ...
    Sauce.findOne({ _id: sauceId })
      .then((sauce) => {
        ...
        // La méthode "includes" permet de déterminer si notre tableau contient l'userId 
